package no.nav.arbeid.registeroppslag.config

import io.javalin.http.Context
import no.nav.arbeid.registeroppslag.KONSUMENT_ID_MDC_KEY
import no.nav.arbeid.registeroppslag.sikkerhet.AzureClientCredentialsKlient
import no.nav.arbeid.registeroppslag.sikkerhet.AzureOBOKlient
import no.nav.arbeid.registeroppslag.sikkerhet.Fodselsnummer
import no.nav.arbeid.registeroppslag.sikkerhet.TokendingsKlient
